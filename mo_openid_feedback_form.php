...
function mo_openid_sh_display_feedback_form(){
                ...
                <div>
                    <p style="margin-left:2%">
                        ...
                        $deactivate_reasons = array(
                            ...
                            "Does not support sharing with app I am looking for",
                            "Confusing Interface",
                            "Bugs in the plugin",
                            "Other Reasons:",
...
<script>
    ...
    jQuery('a[aria-label="Deactivate Social Sharing by miniOrange"]').click(function(){
        ...
        jQuery('input:radio[name="deactivate_plugin"]').click(function () {
            ...
            if(reason=='Facing issues During Registration'){
                ...
                add_text_box(1,"Let us know what feature are you looking for");
            }else if(reason=="Other Reasons:"){
                add_text_box(5,"Can you let us know the reason for deactivation?");
            }else if(reason=="Bugs in the plugin"){
                add_text_box(4,"Can you please let us know about the bug in detail?");
            }else if(reason=="Does not support sharing with app I am looking for"){
                add_text_box(2,"Let us know which App are you looking for");
