<?php
function mo_ss_openid_customize_icons(){
    ?>
    ...
    <div class="mo_openid_table_layout">
        ...
        <div style="width: 100%;">
            <table style="width: 100%">
                <tr>
                    <td>
                        <h3><?php echo sh_mo_sl('Customize Sharing Icons');?></h3>
                ...
                <tr>
                    <td>
                        <table style="width=100%">
                            <tr >
                                <td class="mo_openid_fix_fontsize_semiheading" style="width: 30%"><?php echo sh_mo_sl('Shape');?></td>
                                <td class="mo_openid_fix_fontsize_semiheading" style="width: 30%"><?php echo sh_mo_sl('Theme');?></td>
                                <td class="mo_openid_fix_fontsize_semiheading" style="width: 25%"><?php echo sh_mo_sl('Space between Icons');?></td>
...
<!--                                    </select>-->
                                ...
                                <td style=" width=30%">
                                 ...
                                 <br>
                                    ...
                                    <label class="mo-openid-radio-container"><?php echo sh_mo_sl('No background');?>*
                            ...
                            <tr>
                               <td colspan="4" class="mo_openid_note_style" style="width: 328%; padding: 10px;"><b>*<?php echo sh_mo_sl('NOTE');?>:</b> <?php echo sh_mo_sl('Custom background: This will change the background color of share icons');?>.<br> <?php echo sh_mo_sl('No background:This will remove the background color of share icons');?>.</td>
                            </tr>
            ...
            <br>
            <hr>
            <h3><?php echo sh_mo_sl('Advance Sharing Icons');?><span style="margin-left: 20%" class="mo-openid-premium"><?php echo sh_mo_sl('PRO');?></span></h3>
            <div ><table style="width:60%">
                    <tr><td>
                            <h2>Hover Icons</h2>
                            <?php echo Cursor_icon_hover_free(); ?><br><br>
                            <label style="cursor: auto" class="mo_openid_note_style">&nbsp;&nbsp;&nbsp;<?php echo sh_mo_sl('Advance Icons are available in the premium version of miniOrange social sharing plugin.');?>.</label>
                        </td></tr>
                </table>
            </div>
            <hr>
            ...
            <br>
            <h3><?php echo sh_mo_sl('Customize Text For Social Share Icons');?></h3>
            <style>
                .share_text{
                    font-size: 15px;
            ...
            <hr>
                    <b class="share_text"><?php echo sh_mo_sl('Select color for share heading');?>:</b>
            ...
            <br><br>
                    <b class="share_text" ><?php echo sh_mo_sl('Enter text to show above share widget');?>:</b>
            ...
            <br><br>
                    <b class="share_text" ><?php echo sh_mo_sl('Enter your twitter Username (without @)');?>:</b>
            ...
            <br><br>
                    ...
                    <b class="share_text"><?php echo sh_mo_sl('Enter the Email subject (email share)');?>:</b>
            ...
            <br><br>
                    ...
                    <b class="share_text"><?php echo sh_mo_sl('Enter the Email body (add ##url## to place the URL)');?>:</b>
            ...
            <br><br>
                    ...
                    <b><input type="submit" name="submit" value="<?php echo sh_mo_sl('Save');?>" style="width:150px;background-color:#0867b2;color:white;box-shadow:none;text-shadow: none;"  class="button button-primary button-large" /></b>
    ...
    <script>
        //to set heading name
        jQuery('#mo_openid_page_heading').text('<?php echo sh_mo_sl('Customize text for Social Share Icons');?>');
    </script>
