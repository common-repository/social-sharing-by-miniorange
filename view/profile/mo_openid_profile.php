...
function mo_ss_openid_profile(){
    if ((get_option ( 'mo_openid_verify_customer' ) == 'true')|| (trim ( get_option ( 'mo_openid_admin_email' ) ) != '' && trim ( get_option ( 'mo_openid_admin_api_key' ) ) == '' && get_option ( 'mo_openid_new_registration' ) != 'true') ) {
        mo_openid_sh_show_verify_password_page();
    }
    else if(!mo_openid_sh_is_customer_registered())
    {
        ...
        ?>
            ...
            <form name="f" method="post" action="" id="register-form">
                ...
                <div class="mo_openid_table_layout">
                    <h3><?php echo ('Register with miniOrange');?></h3>
                    <p style="font-size:14px;"><b><?php echo ('Why should I register?');?> </b></p>
                    <div id="help_register_desc" style="background: aliceblue; padding: 10px 10px 10px 10px; border-radius: 10px;">
                        <?php echo ('By registering with miniOrange we take care of creating applications for you so that you don’t have to worry about creating applications in each social network.');?>
                        <br/><b><?php echo ('Please Note');?>:</b><?php echo ( 'We do not store any information except the email that you will use to register with us. You can go through our ');?><a href="https://www.miniorange.com/usecases/miniOrange_Privacy_Policy.pdf" target="_blank"><?php echo ('Privacy Policy');?></a> <?php echo ('for how we use your information. We don’t sell your information to any third-party organization');?>.
                    </div><br/>
                    <table class="mo_openid_settings_table" style="padding-right: 20%">
                        <tr>
                            <td><b><font color="#FF0000">*</font><?php echo ('Email');?>:</b></td>
                        ...
                        <tr>
                            <td><b><font color="#FF0000">*</font><?php echo ('Password');?>:</b></td>
                        ...
                        <tr>
                            <td><b><font color="#FF0000">*</font><?php echo ('Confirm Password');?>:</b></td>
                            <td><input class="mo_openid_textfield_css" style="border: 1px solid ;border-color: #0867b2;width: 80%" required type="password"
                    ...
                    <br/><?php echo ('By clicking Submit, you agree to our');?> <a href="https://www.miniorange.com/usecases/miniOrange_Privacy_Policy.pdf" target="_blank"><?php echo ('Privacy Policy');?></a> <?php echo ('and');?> <a href="https://www.miniorange.com/usecases/miniOrange_User_Agreement.pdf" target="_blank"><?php echo ('User Agreement');?></a>.
                </div>
            </form>
        ...
        ?>
        <div class="mo_openid_table_layout">
            <h2><?php echo ('Thank you for registering with miniOrange');?>.</h2>
            <table border="1" style="background-color:#FFFFFF; border:1px solid #CCCCCC; border-collapse: collapse; padding:0px 0px 0px 10px; margin:2px; width:85%">
                <tbody><tr>
                    <td style="width:45%; padding: 10px;"><?php echo ('miniOrange Account Email');?></td>
                    <td style="width:55%; padding: 10px;"><?php echo get_option("mo_openid_admin_email"); ?></td>
                </tr>
                <tr>
                    <td style="width:45%; padding: 10px;"><?php echo ('Customer ID');?></td>
                    <td style="width:55%; padding: 10px;"><?php echo get_option("mo_openid_admin_customer_key"); ?></td>
                </tr>
                </tbody>
            </table>
            <br/><label style="cursor: auto"><a href="<?php echo get_site_url() . "/wp-admin/admin.php?page=mo_ss_openid_settings&tab=license_plan";?>"><?php echo ('Click here');?></a><?php echo (' to check our');?> <a style="left: 1%; position: static; text-decoration: none" class="mo-openid-premium" href="<?php echo add_query_arg( array('tab' => 'license_plan'), $_SERVER['REQUEST_URI'] ); ?>"><?php echo ('PRO');?></a> <?php echo ('plans');?></label>
        </div>
        <?php
    }
    ?>
    <script>
        //to set heading name
        jQuery('#mo_openid_page_heading').text('<?php echo sh_mo_sl('User Profile Details');?>');
