...
.mo_support_close:focus {
    ...
    <div id="myModal" class="modal_support_form">
        <div id="mo_support_form" class="modal-content_support_form" >
            ...
            <h1>SUPPORT</h1>
            <p style="padding-left: 4px;">Need any help? Couldn\'t find an answer in <a href=" '. add_query_arg( array("tab" => "faq"), sanitize_text_field($_SERVER["REQUEST_URI"] )).'">Frequently Asked Questions</a>?<br>
