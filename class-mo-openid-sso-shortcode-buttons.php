...
function sh_count_convert($count)
{
    if($count>=1000000){
        $count=$count/1000000;
        $count=$count."M";
...
function mo_openid_sh_share_shortcode( $atts = '', $title = '', $excerpt = '' ) {
   ...
   // wp_enqueue_style( 'mo_openid_admin_settings_style', plugins_url('includes/css/mo_openid_style.css?version=7.3.0', __FILE__));
    wp_enqueue_style( 'mo-wp-style-icon',plugins_url('includes/css/mo_openid_sharing_style.css?version=7.3.0', __FILE__), false );
    ...
    if( $orientation == 'hor' ) {
        ...
        if($custom_theme == 'custom'){
            ...
            if( get_option('mo_openid_linkedin_share_enable') ) {
                $link='https://www.linkedin.com/sharing/share-offsite/?url='.$url.'&title='.$title;
                if ($sharing_counts){
                    $html .= "<li>";
                }
            ...
            if (get_option('mo_openid_vkontakte_share_enable')) {
                ...
                if ($sharing_counts){
                    ...
                    $html .= "<a rel='nofollow' title='Vkontakte' onclick='popupCenter(" . '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link' style='margin-left : " . ($spaceBetweenIcons - 6) . "px !important'><i class=' " . $selected_theme . " mofa mofa-vk' style='padding-top:4px;text-align:center;color:" . $fontColor . ";font-size:" . $sharingSize . "px !important;height:" . $sharingSize . "px !important;width:" . $sharingSize . "px !important;'></i></a>"; if($sharing_counts){$html .= "<span2 style='margin-left : " . ($spaceBetweenIcons) . "px !important'></span2></li>";};
            }
            if (get_option('mo_openid_tumblr_share_enable')) {
                $link = 'http://www.tumblr.com/share/link?url=' . $url . '&amp;title=' . $title;
            ...
            if (get_option('mo_openid_pinterest_share_enable')) {
                if ($sharing_counts){
                    ...
                    $html .= "<li style='line-height: 0.0px'>";
                } $html .= "<a rel='nofollow' title='Pinterest' href='javascript:pinIt();' class='mo-openid-share-link' style='margin-left : " . ($spaceBetweenIcons - 6) . "px !important'><i class=' " . $selected_theme . " mofa mofa-pinterest' style='padding-top:4px;text-align:center;color:" . $fontColor . ";font-size:" . $sharingSize . "px !important;height:" . $sharingSize . "px !important;width:" . $sharingSize . "px !important;'></i></a>"; if($sharing_counts){$html .= "<span2 style='margin-left : " . ($spaceBetweenIcons) . "px !important'></span2></li>";};
            }
            ...
            if( get_option('mo_openid_whatsapp_share_enable') ) {
                ...
                if (wp_is_mobile()){
                    ...
                    if ($sharing_counts){$html .= "<li style='line-height: 0.0px'>";} $html .= '<a rel="nofollow"  title="Whatsapp" target ="_blank" href="https://web.whatsapp.com/send?text=' . $url . '" class="mo-openid-share-link" style="margin-left :  '. ($spaceBetweenIcons) . 'px !important; border-bottom:0px !important;"><img alt="Whatsapp" style= "height:  '. $sharingSize . 'px !important;width:  '. $sharingSize . 'px !important;" src="'. plugins_url( "includes/images/icons/whatsapp.png", __FILE__ ) . '" class="mo-openid-app-share-icons  '. $selected_theme . '" ></a>'; if($sharing_counts){$html .= "<span2 style='margin-left : " . ($spaceBetweenIcons) . "px !important'></span2></li>";};
                }
...
function mo_openid_sh_vertical_share_shortcode( $atts = '', $title = '', $excerpt = '' ) {
    wp_enqueue_style( 'mo-openid-sl-wp-font-awesome',plugins_url('includes/css/mo-font-awesome.min.css', __FILE__), false );
   // wp_enqueue_style( 'mo_openid_admin_settings_style', plugins_url('includes/css/mo_openid_style.css?version=7.3.0', __FILE__));
    wp_enqueue_style( 'mo-wp-style-icon',plugins_url('includes/css/mo_openid_sharing_style.css?version=7.3.0', __FILE__), false );
...
//    $spaceBetweenIcons = isset( $atts['space'] )? esc_attr($atts['space']) : '10';
    $spaceBetweenIcons= get_option('mo_sharing_icon_space')+6;
    ...
    if($custom_theme == 'custom'){
        ...
        $html .= "<a rel='nofollow' title='line' onclick='mo_all_features_clk()' class='mo-openid-share-link mo-openid-vertical-app-share-icon ' ><img class='mo-custom-share-icon " .$selected_theme. "' style='padding:6px; margin-bottom : " . ($spaceBetweenIcons-6) . "px !important;text-align:center;color:#ffffff;font-size:" .($sharingSize-16). "px !important;background-color:#" .$custom_color. ";height:" .$sharingSize. "px !important;width:" .$sharingSize. "px !important;' src=". plugins_url( 'includes/images/icons/pluss.png', __FILE__ )."></a>";
        ...
        if( get_option('mo_openid_facebook_share_enable') ) {
            $link = 'https://www.facebook.com/sharer/sharer.php?u='.$url.'&src=sdkpreparse';
            $html .=	"<a rel='nofollow' title='Facebook' onclick='popupCenter(" . '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link'><img alt='Facebook' style= 'margin-bottom : " . ($spaceBetweenIcons-6) . "px !important;height: " . $sharingSize . "px !important;width: " . $sharingSize . "px !important;' src='" . plugins_url( 'includes/images/icons/facebook.png', __FILE__ ) . "' class='mo-openid-vertical-app-share-icon " . $selected_theme . "' ></a>";
        }

        if( get_option('mo_openid_twitter_share_enable') ) {
            $link = empty($twitter_username) ? 'https://twitter.com/intent/tweet?text='.$title.'&amp;url='.$url : 'https://twitter.com/intent/tweet?text='.$title.'&amp;url='.$url. '&amp;via='.$twitter_username;
            $html .=	"<a rel='nofollow' title='Twitter' onclick='popupCenter(" . '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link'><img alt='Twitter' style= 'margin-bottom : " . ($spaceBetweenIcons-6) . "px !important;height: " . $sharingSize . "px !important;width: " . $sharingSize . "px !important;' src='" . plugins_url( 'includes/images/icons/twitter.png', __FILE__ ) . "' class='mo-openid-vertical-app-share-icon " . $selected_theme . "' ></a>";
        }

        if( get_option('mo_openid_google_share_enable') ) {
            $link = 'https://plus.google.com/share?url='.$url;

            $html .=	"<a rel='nofollow' title='Google' onclick='popupCenter(" . '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link'><img alt='Google' style= 'margin-bottom : " . ($spaceBetweenIcons-6) . "px !important;height: " . $sharingSize . "px !important;width: " . $sharingSize . "px !important;' src='" . plugins_url( 'includes/images/icons/google.png', __FILE__ ) . "' class='mo-openid-vertical-app-share-icon " . $selected_theme . "' ></a>";
        }
        if( get_option('mo_openid_vkontakte_share_enable') ) {
            $link = 'http://vk.com/share.php?url='.$url.'&amp;title='.$title.'&amp;description='.$excerpt;
            $html .=	"<a rel='nofollow' title='Vkontakte' onclick='popupCenter(" . '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link'><img alt='Vkontakte' style= 'margin-bottom : " . ($spaceBetweenIcons-6) . "px !important;height: " . $sharingSize . "px !important;width: " . $sharingSize . "px !important;' src='" . plugins_url( 'includes/images/icons/vk.png', __FILE__ ) . "' class='mo-openid-vertical-app-share-icon " . $selected_theme . "' ></a>";
        }
        if( get_option('mo_openid_tumblr_share_enable') ) {
            $link = 'http://www.tumblr.com/share/link?url='.$url.'&amp;title='.$title;
            $html .=	"<a rel='nofollow' title='Tumblr' onclick='popupCenter(" . '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link'><img alt='Tumblr' style= 'margin-bottom : " . ($spaceBetweenIcons-6) . "px !important;height: " . $sharingSize . "px !important;width: " . $sharingSize . "px !important;' src='" . plugins_url( 'includes/images/icons/tumblr.png', __FILE__ ) . "' class='mo-openid-vertical-app-share-icon " . $selected_theme . "' ></a>";
        }
        if( get_option('mo_openid_stumble_share_enable') ) {
            $link = 'http://www.stumbleupon.com/submit?url='.$url.'&amp;title='.$title;
            $html .=	"<a rel='nofollow' title='StumbleUpon' onclick='popupCenter(" . '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link'><img alt='StumbleUpon' style= 'margin-bottom : " . ($spaceBetweenIcons-6) . "px !important;height: " . $sharingSize . "px !important;width: " . $sharingSize . "px !important;' src='" . plugins_url( 'includes/images/icons/stumble.png', __FILE__ ) . "' class='mo-openid-vertical-app-share-icon" . $selected_theme . "' ></a>";
        }
        if( get_option('mo_openid_linkedin_share_enable') ) {
            $link = 'https://www.linkedin.com/shareArticle?mini=true&amp;title='.$title.'&amp;url='.$url.'&amp;summary='.$excerpt;
            $html .=	"<a rel='nofollow' title='LinkedIn' onclick='popupCenter(" . '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link'><img alt='LinkedIn' style= 'margin-bottom : " . ($spaceBetweenIcons-6) . "px !important;height: " . $sharingSize . "px !important;width: " . $sharingSize . "px !important;' src='" . plugins_url( 'includes/images/icons/linkedin.png', __FILE__ ) . "' class='mo-openid-vertical-app-share-icon" . $selected_theme . "' ></a>";
        }
        if( get_option('mo_openid_reddit_share_enable') ) {
            $link = 'http://www.reddit.com/submit?url='.$url.'&amp;title='.$title;
            $html .=	"<a rel='nofollow' title='Reddit' onclick='popupCenter(" . '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link'><img alt='Reddit' style= 'margin-bottom : " . ($spaceBetweenIcons-6) . "px !important;height: " . $sharingSize . "px !important;width: " . $sharingSize . "px !important;' src='" . plugins_url( 'includes/images/icons/reddit.png', __FILE__ ) . "' class='mo-openid-vertical-app-share-icon " . $selected_theme . "' ></a>";
        }
        if( get_option('mo_openid_pinterest_share_enable') ) {
            $html .=	"<a rel='nofollow' title='Pinterest' href='javascript:pinIt();' class='mo-openid-share-link'><img alt='Pinterest' style= 'margin-bottom : " . ($spaceBetweenIcons-6) . "px !important;height: " . $sharingSize . "px !important;width: " . $sharingSize . "px !important;' src='" . plugins_url( 'includes/images/icons/pinterest.png', __FILE__ ) . "' class='mo-openid-vertical-app-share-icon" . $selected_theme . "' ></a>";
        }
        if( get_option('mo_openid_pocket_share_enable') ) {
            $link = 'https://getpocket.com/save?url='.$url.'&amp;title='.$title;
            $html .=	"<a rel='nofollow' title='Pocket' onclick='popupCenter(" . '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link'><img alt='Pocket' style= 'margin-bottom : " . ($spaceBetweenIcons-6) . "px !important;height: " . $sharingSize . "px !important;width: " . $sharingSize . "px !important;' src='" . plugins_url( 'includes/images/icons/pocket.png', __FILE__ ) . "' class='mo-openid-vertical-app-share-icon " . $selected_theme . "' ></a>";
        }
        if( get_option('mo_openid_digg_share_enable') ) {
            $link = 'http://digg.com/submit?url='.$url.'&amp;title='.$title;
            $html .=	"<a rel='nofollow' title='Digg' onclick='popupCenter(" . '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link'><img alt='Digg' style= 'margin-bottom : " . ($spaceBetweenIcons-6) . "px !important;height: " . $sharingSize . "px !important;width: " . $sharingSize . "px !important;' src='" . plugins_url( 'includes/images/icons/digg.png', __FILE__ ) . "' class='mo-openid-vertical-app-share-icon " . $selected_theme . "' ></a>";
        }
        
        if( get_option('mo_openid_mail_share_enable') ) {
            $html .= "<a rel='nofollow' title='Email this page' onclick='popupCenter(" . '"mailto:?subject= ' . $email_subject . '&amp;body=' . $email_body. '"' . ", 800, 500);' class='mo-openid-share-link'><img alt='Email this page' style= 'margin-bottom : " . ($spaceBetweenIcons-6) . "px !important; height: " . $sharingSize . "px !important;width: " . $sharingSize . "px !important;' src='" . plugins_url( 'includes/images/icons/mail.png', __FILE__ ) . "' class='mo-openid-vertical-app-share-icon " . $selected_theme . "' ></a>";
        }
        if( get_option('mo_openid_print_share_enable') ) {
            $html .= "<a rel='nofollow' title='Print this page' onclick='javascript:window.print();' class='mo-openid-share-link'><img alt='Print this page' style= 'margin-bottom : " . ($spaceBetweenIcons-6) . "px !important; height: " . $sharingSize . "px !important;width: " . $sharingSize . "px !important;' src='" . plugins_url( 'includes/images/icons/print.png', __FILE__ ) . "' class='mo-openid-vertical-app-share-icon" . $selected_theme . "' ></a>";
        }
        if( get_option('mo_openid_whatsapp_share_enable') ) {
            if(wp_is_mobile()){
                $html .= '<a rel="nofollow" title="Whatsapp" href="whatsapp://send?text=' . $url ."\" class='mo-openid-share-link'><img alt='Whatsapp' style= 'margin-bottom : " . ($spaceBetweenIcons-6) . "px !important;height: " . $sharingSize . "px !important;width: " . $sharingSize . "px !important;' src='" . plugins_url( 'includes/images/icons/whatsapp.png', __FILE__ ) . "' class='mo-openid-vertical-app-share-icon " . $selected_theme . "' ></a>";
            }
            else{
        ...
        $html .= "<a rel='nofollow' title='line' onclick='mo_all_features_clk()' class='mo-openid-share-link mo-openid-vertical-app-share-icon  '><img alt='line' style= 'margin-bottom : " . ($spaceBetweenIcons-6) . "px !important;height: " . $sharingSize . "px !important;width: " . $sharingSize . "px !important;' src='" . plugins_url( 'includes/images/icons/plus1.png', __FILE__ ) . "' class='mo-openid-vertical-app-share-icon  " . $selected_theme . "' ></a>";
    ...
    $app_arr = array('facebook' =>  'https://www.facebook.com/dialog/share?app_id=766555246789034&amp;display=popup&amp;href='.$url,
        'twitter' =>  'https://twitter.com/intent/tweet?text='.$title.'&amp;url='.$url,
        'vkontakte' => 'http://vk.com/share.php?url='.$url.'&amp;title='.$title.'&amp;description='.$title,
        'linkedin'=>  'https://www.linkedin.com/shareArticle?mini=true&amp;title='.$title.'&amp;url='.$url.'&amp;summary='.$title,
        'tumblr'=> 'http://www.tumblr.com/share/link?url='.$url.'&amp;title='.$title.'&amp;description='.$title,
        'stumble' =>'http://www.stumbleupon.com/submit?url='.$url.'&amp;title='.$title,
        'reddit' => 'http://www.reddit.com/submit?url='.$url.'&amp;title='.$title,
        'pinterest' => 'javascript:pinIt();',
        'pocket' => 'https://getpocket.com/save?url='.$url.'&amp;title='.$title,
        'digg' =>  'http://digg.com/submit?url='.$url.'&amp;title='.$title,
        'mail' => 'mailto:?subject='.$title.'&amp;body='.$url,
        'print' => 'javascript:window.print()',
        'whatsapp'=> 'whatsapp://send?text=<?php echo $url?>'
        );

    $html .= " <div id='myModal_3' class='mo_openid_popup-modal' style='width: 100%;'>";
    $html .= "<div class='mo_openid_modal-content'>";
    $html .= "<div class='mo-openid-app-icons circle '>";
    $count= 0;
    $html.= "<table style='border: 1px solid transparent'>";
    if($custom_theme=='default'){
        foreach($app_arr as $app_name=>$link){
            if( !get_option('mo_openid_'.$app_name.'_share_enable')){
                if($count==0) {
                    $html .= "<tr>";
                }

                $html.="<td style='border: 1px solid transparent'>";
                $html .= "<a rel='nofollow' title=".$app_name ." onclick='popupCenter( <?php echo $link;?> , 800, 500)' href='". $link."' target='_blank' class='mo-openid-share-link mo-openid-vertical-app-share-icon '><center><img alt=".$app_name." style= ' height: 55px !important;width: 55px !important;' src= ' ". plugins_url( 'includes/images/icons/'.$app_name.'.png', __FILE__ ) ."' class='mo-openid-vertical-app-share-icon ". $selected_theme. "'></center></a>";
                $html .="</td>";
                $count++;
                if($count==6){
                    $html .="</tr>";
    ...
    if($custom_theme=='custom'){
        foreach($app_arr as $app_name=>$link){
            if( !get_option('mo_openid_'.$app_name.'_share_enable')){
                ...
                $html.="<td style='border: 1px solid transparent'>";
                $html .= "<a rel='nofollow' title=".$app_name ." onclick='popupCenter(". '"' . $link . '"' .", 800, 500);' href='". $link."' target='_blank' class='mo-openid-share-link mo-openid-vertical-app-share-icon' ><img alt=".$app_name." class='mo-custom-share-icon " .$selected_theme. " mofa mofa-".$app_name."' style='height: 55px !important;width: 55px !important;padding-top:8px;text-align:center;color:#ffffff;font-size:" .($sharingSize-16). "px !important;background-color:#" .$custom_color. ";' src=' ". plugins_url( 'includes/images/icons/'.$app_name.'s.png', __FILE__ ) ."'.'></a>";
//                $html .= "<a rel='nofollow' title='".$app_name ."' onclick='popupCenter(". '"' . $link . '"' .", 800, 500);' href='". $link."' target='_blank' class='mo-openid-share-link mo-openid-vertical-app-share-icon ".$dis." ' ><img class='mo-custom-share-icon " .$selected_theme. " mofa mofa-vk' style='margin-bottom : " . ($spaceBetweenIcons-4) . "px !important;padding-top:8px;text-align:center;color:#ffffff;font-size:" .($sharingSize-16). "px !important;background-color:#" .$custom_color. ";height:" .$sharingSize. "px !important;width:" .$sharingSize. "px !important;' src=". plugin_url . '/vkontaktes.png'."></a>";
    ...
    $html .= '<script>';
    $html .= 'function mo_all_features_clk(){';
    $html .= 'document.getElementById("myModal_3").style.display="block";';
    $html .='}';
    $html .= 'window.onclick = function(event) {';
    $html .= 'if (event.target == document.getElementById("myModal_3")) {';
    $html .=  'document.getElementById("myModal_3").style.display = "none";';
    $html .= '}';
    $html .= '}';
    $html .='</script>';
...
function mo_openid_sh_follow_us_shortcode(){
    wp_enqueue_style( 'mo-openid-sl-wp-font-awesome',plugins_url('includes/css/mo-font-awesome.min.css', __FILE__), false );
    wp_enqueue_style( 'mo-wp-style-icon',plugins_url('includes/css/mo_openid_sharing_style.css?version=7.3.0', __FILE__), false );


    $html = '';
$selected_theme = isset( $atts['shape'] )? esc_attr($atts['shape']) : esc_attr(get_option('mo_openid_follow_us_theme'));
$sharingSize = isset( $atts['size'] )? esc_attr($atts['size']) : esc_attr(get_option('mo_follow_us_icon_custom_size'));
$custom_color = isset( $atts['backgroundcolor'] )? esc_attr($atts['backgroundcolor']) : esc_attr(get_option('mo_openid_follow_us_icon_custom_color'));
$custom_theme = isset( $atts['theme'] )? esc_attr($atts['theme']) : esc_attr(get_option('mo_openid_follow_us_custom_theme'));
$fontColor = isset( $atts['fontcolor'] )? esc_attr($atts['fontcolor']) : esc_attr(get_option('mo_openid_follow_us_icon_custom_font'));
$spaceBetweenIcons = isset( $atts['space'] )? esc_attr($atts['space']) : esc_attr(get_option('mo_openid_follow_us_icon_space'));
...
$html .= '<div class="mo-openid-app-icons circle ">';
        ...
        $html .= "<div class='horizontal'>";
        if($custom_theme == 'custom'){
                if( get_option('mo_openid_twitter_follow_us_check') ) {
                $link = get_option('mo_openid_twitter_follow_url');
                $html .= "<a rel='nofollow' title='Facebook' onclick='popupCenter(". '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link mo-openid-app-share-icons ' style='margin-left : " .($spaceBetweenIcons) . "px !important'><img class='mo-custom-share-icon  " .$selected_theme. " mofa mofa-google-plus' style='margin-bottom:0px!important;padding-top:1px;text-align:center;color:#ffffff;font-size:" .($sharingSize-16). "px !important;background-color:#" .$custom_color. ";height:" .$sharingSize. "px !important;width:" .$sharingSize. "px !important;margin-bottom: -12px;' src=". mo_ss_plugin_url . '/twitters.png'."></a>";

                }
                if( get_option('mo_openid_facebook_follow_us_check') ) {
                $link = get_option('mo_openid_facebook_follow_url');
                $html .= "<a rel='nofollow' title='Facebook' onclick='popupCenter(". '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link mo-openid-app-share-icons ' style='margin-left : " .($spaceBetweenIcons) . "px !important'><img class='mo-custom-share-icon  " .$selected_theme. " mofa mofa-google-plus' style='margin-bottom:0px!important;padding-top:1px;text-align:center;color:#ffffff;font-size:" .($sharingSize-16). "px !important;background-color:#" .$custom_color. ";height:" .$sharingSize. "px !important;width:" .$sharingSize. "px !important;margin-bottom: -12px;' src=". mo_ss_plugin_url . '/facebooks.png'."></a>";

                }
                if( get_option('mo_openid_pinterest_follow_us_check') ) {
                $link = get_option('mo_openid_pinterest_follow_url');
                $html .= "<a rel='nofollow' title='Pinterest' onclick='popupCenter(". '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link mo-openid-app-share-icons ' style='margin-left : " .($spaceBetweenIcons) . "px !important'><img class='mo-custom-share-icon  " .$selected_theme. " mofa mofa-pinterest-plus' style='margin-bottom:0px!important;padding-top:1px;text-align:center;color:#ffffff;font-size:" .($sharingSize-16). "px !important;background-color:#" .$custom_color. ";height:" .$sharingSize. "px !important;width:" .$sharingSize. "px !important;margin-bottom: -12px;' src=". mo_ss_plugin_url . '/pinterests.png'."></a>";

                }
                if( get_option('mo_openid_linkedin_follow_us_check') ) {
                $link = get_option('mo_openid_linkedin_follow_url');
                $html .= "<a rel='nofollow' title='LinkedIn' onclick='popupCenter(". '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link mo-openid-app-share-icons ' style='margin-left : " .($spaceBetweenIcons) . "px !important'><img class='mo-custom-share-icon  " .$selected_theme. " mofa mofa-instagram' style='margin-bottom:0px!important;padding-top:1px;text-align:center;color:#ffffff;font-size:" .($sharingSize-16). "px !important;background-color:#" .$custom_color. ";height:" .$sharingSize. "px !important;width:" .$sharingSize. "px !important;margin-bottom: -12px;' src=". mo_ss_plugin_url . '/linkedins.png'."></a>";

                }
                if( get_option('mo_openid_instagram_follow_us_check') ) {
                $link = get_option('mo_openid_instagram_follow_url');
                $html .= "<a rel='nofollow' title='Instagram' onclick='popupCenter(". '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link mo-openid-app-share-icons ' style='margin-left : " .($spaceBetweenIcons) . "px !important'><img class='mo-custom-share-icon  " .$selected_theme. " mofa mofa-google-plus' style='margin-bottom:0px!important;padding-top:1px;text-align:center;color:#ffffff;font-size:" .($sharingSize-16). "px !important;background-color:#" .$custom_color. ";height:" .$sharingSize. "px !important;width:" .$sharingSize. "px !important;margin-bottom: -12px;' src=". mo_ss_plugin_url . '/insta2.png'."></a>";

                }
                if( get_option('mo_openid_tumblr_follow_us_check') ) {
                $link = get_option('mo_openid_tumblr_follow_url');
                $html .= "<a rel='nofollow' title='Tumblr' onclick='popupCenter(". '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link mo-openid-app-share-icons ' style='margin-left : " .($spaceBetweenIcons) . "px !important'><img class='mo-custom-share-icon  " .$selected_theme. " mofa mofa-google-plus' style='margin-bottom:0px!important;padding-top:1px;text-align:center;color:#ffffff;font-size:" .($sharingSize-16). "px !important;background-color:#" .$custom_color. ";height:" .$sharingSize. "px !important;width:" .$sharingSize. "px !important;margin-bottom: -12px;' src=". mo_ss_plugin_url . '/tumblrs.png'."></a>";
                ...
                if($custom_theme == 'default'){
                        if( get_option('mo_openid_twitter_follow_us_check') ) {
                        $link = get_option('mo_openid_twitter_follow_url');
                        $html .=   "<a rel='nofollow' title='Twitter' onclick='popupCenter(" . '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link mo-openid-app-share-icons  ' style='margin-left : " . ($spaceBetweenIcons) . "px !important'><img alt='Twitter' style= 'height: " . $sharingSize . "px !important;width: " . $sharingSize . "px !important;background-color: " . $selected_theme . "' src='" . plugins_url( 'includes/images/icons/twitter.png', __FILE__ ) . "' class='mo-openid-app-share-icons " . $selected_theme . "' ></a>";

                        }
                        if( get_option('mo_openid_facebook_follow_us_check') ) {
                        $link = get_option('mo_openid_facebook_follow_url');
                        $html .= "<a rel='nofollow' title='Facebook' onclick='popupCenter(" . '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link mo-openid-app-share-icons  ' style='margin-left : " . ($spaceBetweenIcons) . "px !important'><img alt='Facebook' style= 'height: " . $sharingSize . "px !important;width: " . $sharingSize . "px !important;background-color: " . $selected_theme . "' src='" . plugins_url( 'includes/images/icons/facebook.png', __FILE__ ) . "' class='mo-openid-app-share-icons " . $selected_theme . "' ></a>";

                        }
                        if( get_option('mo_openid_pinterest_follow_us_check') ) {
                        $link = get_option('mo_openid_pinterest_follow_url');
                        $html .= "<a rel='nofollow' title='Pinterest' onclick='popupCenter(" . '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link mo-openid-app-share-icons  ' style='margin-left : " . ($spaceBetweenIcons) . "px !important'><img alt='Facebook' style= 'height: " . $sharingSize . "px !important;width: " . $sharingSize . "px !important;background-color: " . $selected_theme . "' src='" . plugins_url( 'includes/images/icons/pinterest.png', __FILE__ ) . "' class='mo-openid-app-share-icons " . $selected_theme . "' ></a>";

                        }
                        if( get_option('mo_openid_linkedin_follow_us_check') ) {
                        $link = get_option('mo_openid_linkedin_follow_url');
                        $html .= "<a rel='nofollow' title='LinkedIn' onclick='popupCenter(" . '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link mo-openid-app-share-icons  ' style='margin-left : " . ($spaceBetweenIcons) . "px !important'><img alt='LinkedIn' style= 'height: " . $sharingSize . "px !important;width: " . $sharingSize . "px !important;background-color: " . $selected_theme . "' src='" . plugins_url( 'includes/images/icons/linkedin.png', __FILE__ ) . "' class='mo-openid-app-share-icons " . $selected_theme . "' ></a>";

                        }
                        if( get_option('mo_openid_instagram_follow_us_check') ) {
                        $link = get_option('mo_openid_instagram_follow_url');
                        $html .= "<a rel='nofollow' title='Instagram' onclick='popupCenter(" . '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link mo-openid-app-share-icons  ' style='margin-left : " . ($spaceBetweenIcons) . "px !important'><img alt='Instagram' style= 'height: " . $sharingSize . "px !important;width: " . $sharingSize . "px !important;background-color: " . $selected_theme . "' src='" . plugins_url( 'includes/images/icons/instagram.png', __FILE__ ) . "' class='mo-openid-app-share-icons " . $selected_theme . "' ></a>";

                        }
                        if( get_option('mo_openid_tumblr_follow_us_check') ) {
                        $link = get_option('mo_openid_tumblr_follow_url');
                        $html .= "<a rel='nofollow' title='Tumblr' onclick='popupCenter(" . '"' . $link . '"' . ", 800, 500);' class='mo-openid-share-link mo-openid-app-share-icons  ' style='margin-left : " . ($spaceBetweenIcons) . "px !important'><img alt='Tumblr' style= 'height: " . $sharingSize . "px !important;width: " . $sharingSize . "px !important;background-color: " . $selected_theme . "' src='" . plugins_url( 'includes/images/icons/tumblr.png', __FILE__ ) . "' class='mo-openid-app-share-icons " . $selected_theme . "' ></a>";
