...
class sh_CustomerOpenID {
    ...
    function sh_create_customer(){
        ...
        $fields = array(
            'areaOfInterest' => 'WP OpenID Connect Share Plugin',
            'email'		=> $this->email,
            'password'	=> $password
        );
        ...
        $response = self::mo_openid_sh_wp_remote_post($url, $args);
        return $response['body'];
    }

    function get_sh_customer_key() {
    ...
    function sh_check_customer_valid(){
        ...
        $currentTimeInMillis = self::sh_get_timestamp();
    ...
    function sh_get_timestamp()
    {
        $url = get_option('mo_openid_host_name') . '/moas/rest/mobile/get-timestamp';
        $response = self::mo_openid_sh_wp_remote_post($url);
        return $response['body'];
    }
    function mo_openid_sh_send_email_alert($email,$phone,$message){
        ...
        $query =" MiniOrange Social Sharing [Free] ";
    ...
    function sh_submit_contact_us( $email, $phone, $query, $feature_plan ) {
        ...
        $query = '[WP OpenID Connect Share Free Plugin Version: '.get_option('mo_openid_social_share_version').'] ' .$feature_plan.":".$query;
        $fields = array(
    ...
    function sh_forgot_password($email){
    ...
    function sh_check_customer_ln($licience_type){
    ...
    function mo_openid_sh_wp_remote_post($url, $args = array()){
